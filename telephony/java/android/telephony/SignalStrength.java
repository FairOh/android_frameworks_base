...
public class SignalStrength implements Parcelable {
    ...
    public int getLteLevel() {
        ...
        else if (mLteRsrp >= -95) rsrpIconLevel = SIGNAL_STRENGTH_GREAT;
        else if (mLteRsrp >= -103) rsrpIconLevel = SIGNAL_STRENGTH_GOOD;
        else if (mLteRsrp >= -108) rsrpIconLevel = SIGNAL_STRENGTH_MODERATE;
        else if (mLteRsrp >= -113) rsrpIconLevel = SIGNAL_STRENGTH_POOR;
        else if (mLteRsrp >= -120) rsrpIconLevel = SIGNAL_STRENGTH_NONE_OR_UNKNOWN;
