...
public class TelephonyIntents {
    ...
    public static final String EXTRA_SPN        = "spn";
     ...
     /**
     * Broadcast Action: Managed Roaming Intent. Used by Phone App to show popup to the end user
     * that location update request rejected with status as "Persistent location update reject",
     * so user can try to do location update on other Network:</p>
     *
     * <p class="note">This is a protected intent that can only be sent
     * by the system.
     */
